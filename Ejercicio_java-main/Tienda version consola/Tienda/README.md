...
2. **Compilar el código (enviándolo a la carpeta `build`):**
   ```bash
...
*(Nota: También puedes usar los scripts `clean.bat` para borrar archivos `.class` sueltos y `clean_and_build.bat` para automatizar este proceso).*
