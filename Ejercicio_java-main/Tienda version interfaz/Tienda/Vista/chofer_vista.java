...
public class chofer_vista extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gestión de Choferes");
        ...
        jLabel3.setFont(fuenteLabels); jLabel3.setForeground(Color.WHITE); jLabel3.setText("Cédula (10 dígitos)");
        jLabel4.setFont(fuenteLabels); jLabel4.setForeground(Color.WHITE); jLabel4.setText("Licencia");
        ...
        jButton1.addActionListener(e ->
            jTextArea1.setText(ctrl.tomar_datos_chofer(jTextField1.getText(), jTextField2.getText(), jTextField3.getText())));
        jButton2.addActionListener(e ->
            jTextArea1.setText(ctrl.enviar_datos_chofer()));
        jButton3.addActionListener(e -> {
            String c = jTextField2.getText().trim();
            jTextArea1.setText(c.isEmpty() ? "Ingrese la cédula para buscar." : ctrl.buscar_chofer(c));
        });
        jButton4.addActionListener(e -> {
            String c = jTextField2.getText().trim();
            jTextArea1.setText(c.isEmpty() ? "Ingrese la cédula para actualizar." :
                ctrl.actualizar_chofer(jTextField1.getText(), c, jTextField3.getText()));
        });
        jButton5.addActionListener(e -> {
            String c = jTextField2.getText().trim();
            jTextArea1.setText(c.isEmpty() ? "Ingrese la cédula para eliminar." : ctrl.eliminar_chofer(c));
        });
