...
public class pasajero_vista extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(fuenteLabels); jLabel2.setForeground(Color.WHITE); jLabel2.setText("Nombre");
        jLabel3.setFont(fuenteLabels); jLabel3.setForeground(Color.WHITE); jLabel3.setText("Apellido");
        jLabel4.setFont(fuenteLabels); jLabel4.setForeground(Color.WHITE); jLabel4.setText("Cédula (10 dígitos)");
        jLabel5.setFont(fuenteLabels); jLabel5.setForeground(Color.WHITE); jLabel5.setText("Teléfono (10 dígitos)");
        ...
        jButton1.addActionListener(e ->
            jTextArea1.setText(ctrl.tomar_datos_pasajero(
                jTextField1.getText(), jTextField2.getText(),
                jTextField3.getText(), jTextField4.getText())));
        jButton2.addActionListener(e ->
            jTextArea1.setText(ctrl.enviar_datos_pasajero()));
        jButton3.addActionListener(e -> {
            String c = jTextField3.getText().trim();
            jTextArea1.setText(c.isEmpty() ? "Ingrese la cédula para buscar." : ctrl.buscar_pasajero(c));
        });
        jButton4.addActionListener(e -> {
            String c = jTextField3.getText().trim();
            jTextArea1.setText(c.isEmpty() ? "Ingrese la cédula para actualizar." :
                ctrl.actualizar_pasajero(jTextField1.getText(), jTextField2.getText(), c, jTextField4.getText()));
        });
        jButton5.addActionListener(e -> {
            String c = jTextField3.getText().trim();
            jTextArea1.setText(c.isEmpty() ? "Ingrese la cédula para eliminar." : ctrl.eliminar_pasajero(c));
        });
